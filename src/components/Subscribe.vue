<script setup>
  import photo from "@/assets/img/subscribe-photo.png";
</script>

<template>
  <div class="subscribe">
    <div class="left">
      <img class="subscribe__photo" :src="photo" alt="Аватар">
    ...
    <div class="right">
      <div class="subscribe__text"> 
        <span style="font-weight: bold; font-size: 24px;">SUBSCRIBE</span> <br> FOR OUR NEWLETTER AND PROMOTION
      </div>
